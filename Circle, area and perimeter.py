...
class Circle:
    ...
    # Calculate and return the area of the circle using the formua: Pi * r^2
    def calculate_circle_area(self):
        return math.pi * self.radius**2

    # Calculate and return the perimeter (circumference) of the circle using the formula: 2Pi * r
